  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li>
          ...
          <li class="nav-item">
          <a class="nav-link" href="LoginForm.jsp"> <span class="fa fa-user-circle"></span>Login</a>
      </li>
       <li class="nav-item">
          <a class="nav-link" href="RegisterForm.jsp"> <span class="fa fa-user-plus"></span>SignUp</a>
      </li>
